...
export default function Home() {
  return <main className="shell"><div className="container">
    ...
    <section style={{padding:"72px 0 48px",display:"flex",justifyContent:"space-between",gap:32,alignItems:"end",flexWrap:"wrap"}}>
      ...
      <div className="card" style={{padding:24,minWidth:250}}><div className="eyebrow">Your 2026 allowance</div><div style={{fontSize:38,fontWeight:800,margin:"10px 0 4px"}}>$150.00</div><div className="muted">$75.00 remaining</div><div style={{height:8,borderRadius:99,background:"#31302c",marginTop:18,overflow:"hidden"}}><div style={{width:"50%",height:"100%",background:"var(--gold)"}} /></div><div className="muted" style={{fontSize:12,marginTop:9}}>50% used</div></div>
    </section>
